...
function Archive() {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', padding: '40px 6%', boxSizing: 'border-box' }}>
      <BackButton />
      <p style={{ fontSize: 'var(--fs-xl)', fontWeight: 800, color: 'var(--text-h)', margin: '0 0 22px' }}>완료된 목표 보관함</p>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  style={{ flexShrink: 0, padding: '10px 20px', fontSize: 'var(--fs-base)', fontWeight: 700 }}
                >
                  복원하기
                </button>
              </div>
